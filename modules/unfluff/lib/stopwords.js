...
void function () {
  var _, cache, candiateWords, getFilePath, path, removePunctuation, stopwords;
  path = require('path');
  _ = require('lodash');
  cache = {};
