...
} from '../side-menu-content/models/side-menu-redirect-events';
...
export class FooterLinksComponent {
    ...
    ngAfterViewInit() {
        this.subscriptionEnter = this.navCtrl.viewDidEnter.subscribe(
            viewCtrl => {
                ...
                const currentViewInList = PagesList.find(
                    item => item.component === viewCtrl.component
                );
